...
with open(os.path.join(CURRENT_DIR, "requirements.txt")) as fin:
...
PYTHON_SRC_DIR = os.path.join(CURRENT_DIR, PACKAGE_NAME)
...
version_str = os.getenv("FASTDEPLOY_VERSION", "0.0.0")
version_file_path = os.path.join(TOP_DIR, 'VERSION_NUMBER')
